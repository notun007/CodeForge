...
{   
    public class LoanCollectionRepository : Repository<LoanCollection>, ILoanCollectionRepository
    {
        public LoanCollectionRepository(ApplicationDbContext dbContext) : base(dbContext)
        {
        }
    }
}
