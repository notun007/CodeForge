...
{    
    public class ServiceDivisionRepository : Repository<ServiceDivision>, IServiceDivisionRepository
    {
        public ServiceDivisionRepository(ApplicationDbContext dbContext) : base(dbContext)
        {
        }
    }
}
